...
public class BookingTicketServiceImpl implements BookingTicketService {
    ...
    @Autowired
    public BookingTicketServiceImpl(BookingRepository bookingRepository, UserRepository userRepository, ShowtimeRepository showtimeRepository, SeatRepository seatRepository, ComboRepository comboRepository, PromotionRepository promotionRepository, EmailService emailService) {
...
//        user.setAccumulatedPoints(user.getAccumulatedPoints() + booking.getPointsEarned());
    ...
    @Override
    public BookingResponse getBookings(BookingRequest bookingRequest){
